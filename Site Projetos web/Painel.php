    ...
    <div id="cadastro"> 
            ...
            <div id="cadastroInformacoes">
                ...
                <form action="<?=$actionForm?>" name="frmCadastro" method="post" enctype="multipart/form-data">
                    ...
                    <div class="campos">
                        ...
                        <div class="cadastroEntradaDeDados">
                            <select name="sltcategoria">
                                ...
                                <?php 
                                    $sql = "select * from tblcategoria order by idcategoria";
                                    ...
                                    {
                                ?>
                                    <option value="<?=$rsCategoria['idcategoria']?>"><?=$rsCategoria['categoria']?> </option>    
                                <?php                              
                                    }
                                ?>                             
                            </select>
                    ...
                    <div class="campos">
                        ...
                        <div class="cadastroEntradaDeDados">
                            <input type="text" name="txtproduto" value="<?=$produto?>" placeholder="Nome do produto" >
                        </div>
                    </div>
                    <div class="campos">
                        <div class="cadastroInformacoesPessoais">
                        ...
                        <div class="cadastroEntradaDeDados">
                            <input type="text" name="txtdescricao" value="<?=$descricao?>" placeholder="Descrição do produto" >
                        </div>
                    </div>.
                    <div class="campos">
                        <div class="cadastroInformacoesPessoais">
                        ...
                        <div class="cadastroEntradaDeDados">
                            <input type="file" name="fleFoto" aceept="image/jpeg, image/png, img/jpg">
                        </div>
                    </div>
                    <div class="enviar">
                    <div class="enviar">
        ...
        <div id="consultaDeDados">
            <table id="tblConsulta" >
                ...
                ?>
                    <tr id="tblLinhas">
                        <td class="tblColunas registros"><?=$listProduto['produto']?></td>
                        <td class="tblColunas registros"><?=$listProduto['descricao']?></td>
                        <td class="tblColunas registros">
                                <img src="arquivos/<?=$listProduto['foto']?>" class='foto'>
                        </td>
                        <td class="tblColunas registros">
                            <a href="Painel.php?modo=editar&id=<?=$listProduto['idproduto']?>">
                                <img src="img/edit.png" alt="Editar" title="Editar" class="editar">
                            </a>
                            <a href="bd/excluirProduto.php?modo=excluir&id=<?=$listProduto['idproduto']?>">
